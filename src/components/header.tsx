...
const Header = () => {
  useEffect(() => {
    const resumeBttn = document.getElementById("test");
      ...
      >
        ...
        >
          <div className="flex flex-col gap-7 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
            <a
              className="font-medium text-red-600 focus:outline-none ring-6 ring-blue-600"
              href="#"
              aria-current="page"
            >
              README
            ...
            <a
              className="font-medium text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-3 focus:ring-red-600 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:ring-neutral-500"
              href={ResumeDocument}
              id="resume"
              rel="noreferrer"
            >
            ...
            <a
              className="font-medium text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-3 focus:ring-gray-600 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:ring-neutral-500"
              href="projects"
            >
              Projects
            </a>
